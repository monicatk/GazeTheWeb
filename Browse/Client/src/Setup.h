...
namespace setup
{
	...
	static const std::string LAB_STREAM_INPUT_NAME = LAB_STREAM_OUTPUT_NAME; // "MiddlewareStream"; // may be set to same value as LAB_STREAM_OUTPUT_NAME to receive own events for debugging purposes
