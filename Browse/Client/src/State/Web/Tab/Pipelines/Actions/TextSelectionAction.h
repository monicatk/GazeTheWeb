...
// - Input: vec2 coordinate in screen space pixels as start point of text selection
// - Output: vec2 coordinate in screen space pixels as end point of text selection
