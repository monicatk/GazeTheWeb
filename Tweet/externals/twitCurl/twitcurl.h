...
public:
	...
	bool userSearch(const std::string& searchQuery, const std::string resultCount);
	...
	bool suggestionsGetSlugs(const std::string lang = "");
	bool suggestionsGet(const std::string slug, const std::string lang = "");
    ...
    /* Twitter block APIs */
	bool blockCreate(const std::string& userInfo, const bool isUserId = false /* in */);
    bool blockDestroy( const std::string& userInfo, const bool isUserId = false /* in */ );
    ...
    bool trendsGet();
	bool trendsGetInternational(const std::string& id);
    bool trendsDailyGet();
